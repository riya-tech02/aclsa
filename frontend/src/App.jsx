...
const [mode, setMode] = useState("login");
  ...
  async function sendMessage() {
    ...
    const res = await fetch(`${API}/message`, {
      ...
      body: JSON.stringify({ user_id: "riya", text: userText })
    });
